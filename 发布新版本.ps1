...
try {
    ...
    # remove _Tmp* capture files and .bak* backups; exclude KeyCapture (diagnostic tool) and empty autogen file
    Get-ChildItem $bep -Recurse -Force -ErrorAction SilentlyContinue | Where-Object {
        $_.Name -like '_Tmp*' -or $_.Name -like '*.bak*' -or $_.Name -eq 'TinyRogues.KeyCapture.dll' -or $_.Name -eq '_AutoGeneratedTranslations.txt'
